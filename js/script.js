...
function calculatePerimeter() {
  ...
  if (isValidInput(sideA) && isValidInput(sideB) && isValidInput(sideC)) {
    ...
    document.getElementById('hasil').textContent = 'Keliling segitiga tersebut adalah: ' + perimeter;
  } else {
    document.getElementById('hasil').textContent = 'Masukkan panjang sisi yang valid.';
  }
}
